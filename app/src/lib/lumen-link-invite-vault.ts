...
export type PendingInvite={id:string;token:string;expiresAt:string;createdAt:string;label?:string};
...
export async function savePendingInvite(invite:{id:string;token:string;expiresAt:string},label?:string){
