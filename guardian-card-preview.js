(()=>{
  function start(){
    ...
    if(!approved){console.error('Guardian approved asset manifest unavailable');return;}
  ...
  const old=document.querySelector('script[data-guardian-approved-manifest]');
  if(old){old.addEventListener('load',start,{once:true});return;}
  const s=document.createElement('script');
  s.src='/guardian-asset-manifest.js?v=guardian-approved-20260814-1';
