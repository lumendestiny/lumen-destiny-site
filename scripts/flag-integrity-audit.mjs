...
if(!lock.includes('/assets/flags/kr-official-locked-v2.svg'))errors.push('flag-runtime-lock.js must enforce the locked Korean flag v2 asset.');
if(errors.length){console.error('\nFLAG INTEGRITY AUDIT FAILED\n'+errors.map(e=>' - '+e).join('\n'));process.exit(1)}
console.log('FLAG INTEGRITY AUDIT PASSED: Korean flag v2 is locked, legacy variants are blocked, and delayed mutation patterns are rejected.');
