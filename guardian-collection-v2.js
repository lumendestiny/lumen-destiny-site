(()=>{
  const tiers=[
    ...
    {key:'legendary',price:100,label:'LEGENDARY 1/1',limit:'1',tone:'#ffd568',bg1:'#0b0702',bg2:'#4b2d04',items:[
      ['sky-dragon','백룡','금(金)','성공 · 권위 · 개운'],['fire-phoenix','주작','화(火)','열정 · 재물 · 승진'],['moon-tiger','청호','목(木)','수호 · 극복 · 도약'],['qilin','녹기린','토(土)','번영 · 성장 · 행운'],['black-turtle','현무','수(水)','안정 · 장수 · 보호']]}
  ];
  const motifs={
