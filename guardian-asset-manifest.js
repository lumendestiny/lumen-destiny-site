...
(()=>{
  const rev='guardian-approved-20260814-2';
  ...
  const assets=Object.freeze({
    ...
    legendary:Object.freeze({src:null,renderer:'legendaryHD',rendererSrc:'/guardian-legendary-hd-art.js?v=20260814-hd-1',kind:'approved-live-vector',motion:'live-motion'})
  });
