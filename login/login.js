...
const copy={
ko:{title:'루멘 명운 로그인',intro:'인연지도와 Guardian 서비스를 안전하게 이어서 사용하려면 로그인해 주세요.',protected:'개인정보 보호를 위해 로그인이 필요한 서비스입니다.',login:'로그인',signup:'직접 가입',email:'이메일',password:'비밀번호',loginBtn:'이메일로 로그인',signupBtn:'이메일로 가입',or:'또는',google:'Google로 계속',kakao:'Kakao로 계속',x:'X로 계속',privacy:'로그인 계정은 서비스 접근과 본인 데이터 구분에만 사용하며, 사주 계산에 입력한 원본 생년월일·출생시간은 계정에 저장하지 않는 원칙을 유지합니다.',privacyLink:'개인정보처리방침',terms:'이용약관',setup:'로그인 화면은 준비되었습니다. 실제 로그인 활성화를 위해 Supabase 프로젝트 연결과 Google·Kakao·X OAuth 키 설정이 필요합니다.',wait:'로그인 처리 중입니다…',signed:'로그인되었습니다. 이동합니다…',checkMail:'가입 요청이 완료되었습니다. 받은 편지함에서 이메일 인증을 완료해 주세요.',error:'로그인을 완료하지 못했습니다. 입력값과 계정 설정을 확인해 주세요.'},
en:{title:'Sign in to Lumen Destiny',intro:'Sign in to continue using Connection Map and Guardian services securely.',protected:'Sign-in is required to protect your personal data.',login:'Sign in',signup:'Create account',email:'Email',password:'Password',loginBtn:'Sign in with email',signupBtn:'Create account with email',or:'or',google:'Continue with Google',kakao:'Continue with Kakao',x:'Continue with X',privacy:'Your account is used only for service access and separating your data. Original birth date and birth time entered for Saju calculations are still not stored in your account.',privacyLink:'Privacy Policy',terms:'Terms of Use',setup:'The login UI is ready. Connect a Supabase project and configure Google, Kakao and X OAuth credentials to activate sign-in.',wait:'Signing you in…',signed:'Signed in. Redirecting…',checkMail:'Account request received. Please verify your email from your inbox.',error:'Unable to complete sign-in. Check your details and provider setup.'},
ja:{title:'ルーメン命運にログイン',intro:'ご縁マップとGuardianサービスを安全に続けて利用するためログインしてください。',protected:'個人情報保護のためログインが必要です。',login:'ログイン',signup:'新規登録',email:'メールアドレス',password:'パスワード',loginBtn:'メールでログイン',signupBtn:'メールで登録',or:'または',google:'Googleで続ける',kakao:'Kakaoで続ける',x:'Xで続ける',privacy:'アカウントはサービスへのアクセスと本人データの区分にのみ使用します。四柱計算で入力した元の生年月日・出生時刻をアカウントに保存しない原則を維持します。',privacyLink:'プライバシーポリシー',terms:'利用規約',setup:'ログイン画面は準備済みです。実際に有効化するにはSupabaseプロジェクト接続とGoogle・Kakao・XのOAuth設定が必要です。',wait:'ログイン処理中…',signed:'ログインしました。移動します…',checkMail:'登録を受け付けました。メール認証を完了してください。',error:'ログインを完了できませんでした。入力内容と設定を確認してください。'},
tl:{title:'Mag-sign in sa Lumen Destiny',intro:'Mag-sign in para ligtas na magpatuloy sa Connection Map at Guardian services.',protected:'Kailangang mag-sign in upang maprotektahan ang personal data.',login:'Mag-sign in',signup:'Gumawa ng account',email:'Email',password:'Password',loginBtn:'Mag-sign in gamit email',signupBtn:'Gumawa ng account gamit email',or:'o',google:'Magpatuloy gamit Google',kakao:'Magpatuloy gamit Kakao',x:'Magpatuloy gamit X',privacy:'Ginagamit ang account para sa service access at paghihiwalay ng iyong data. Hindi pa rin sine-save sa account ang orihinal na birth date at birth time para sa Saju calculation.',privacyLink:'Patakaran sa Privacy',terms:'Mga Tuntunin',setup:'Handa na ang login screen. Kailangan ikonekta ang Supabase at i-configure ang Google, Kakao at X OAuth para ma-activate.',wait:'Nag-sign in…',signed:'Naka-sign in na. Lilipat na…',checkMail:'Natanggap ang signup. I-verify ang email mula sa inbox.',error:'Hindi nakumpleto ang sign-in. Suriin ang detalye at provider setup.'},
vi:{title:'Đăng nhập Lumen Destiny',intro:'Đăng nhập để tiếp tục sử dụng Bản đồ quan hệ và Guardian một cách an toàn.',protected:'Cần đăng nhập để bảo vệ dữ liệu cá nhân.',login:'Đăng nhập',signup:'Tạo tài khoản',email:'Email',password:'Mật khẩu',loginBtn:'Đăng nhập bằng email',signupBtn:'Tạo tài khoản bằng email',or:'hoặc',google:'Tiếp tục với Google',kakao:'Tiếp tục với Kakao',x:'Tiếp tục với X',privacy:'Tài khoản chỉ được dùng để truy cập dịch vụ và tách dữ liệu của từng người. Ngày sinh và giờ sinh gốc nhập để tính Tứ trụ vẫn không được lưu vào tài khoản.',privacyLink:'Chính sách riêng tư',terms:'Điều khoản sử dụng',setup:'Màn hình đăng nhập đã sẵn sàng. Cần kết nối dự án Supabase và cấu hình OAuth Google, Kakao, X để kích hoạt.',wait:'Đang đăng nhập…',signed:'Đã đăng nhập. Đang chuyển trang…',checkMail:'Đã nhận yêu cầu đăng ký. Vui lòng xác minh email trong hộp thư.',error:'Không thể hoàn tất đăng nhập. Hãy kiểm tra thông tin và cấu hình nhà cung cấp.'},
zh:{title:'登录 Lumen Destiny',intro:'登录后可安全继续使用缘分地图和 Guardian 服务。',protected:'为保护个人信息，使用此服务需要登录。',login:'登录',signup:'注册账号',email:'邮箱',password:'密码',loginBtn:'使用邮箱登录',signupBtn:'使用邮箱注册',or:'或',google:'使用 Google 继续',kakao:'使用 Kakao 继续',x:'使用 X 继续',privacy:'账号仅用于服务访问和区分本人数据。四柱计算中输入的原始出生日期与时间仍不会保存到账号中。',privacyLink:'隐私政策',terms:'使用条款',setup:'登录界面已准备完成。实际启用前需要连接 Supabase 项目，并配置 Google、Kakao、X OAuth。',wait:'正在登录…',signed:'已登录，正在跳转…',checkMail:'注册请求已提交，请在邮箱中完成验证。',error:'无法完成登录，请检查输入内容和登录提供商设置。'}
};
const T=copy[lang];
...
function applyCopy(){
  ...
  document.querySelector('[data-social-label="kakao"]').textContent=T.kakao;
